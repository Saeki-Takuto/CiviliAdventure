...
void InitRankingScore(void)
{
	...
	{
		g_aRankScore[nCntRank].pos = D3DXVECTOR3(700.0f, 250.0f + (nCntRank * 80.0f)+(20.0f*nCntRank), 0.0f);
...
void ResetRanking(void)
{
	...
	//{
	//	sprintf(rankingfilename, "data/RANKING/Normal/ranking.txt");
	//}
	//else if (GetModeMenu() == MODE_MENU_WASUKEMODE)
	//{
	//	sprintf(rankingfilename, "data/RANKING/Yamada/ranking.txt");
	//}

	//pFile = fopen(rankingfilename, "r");
